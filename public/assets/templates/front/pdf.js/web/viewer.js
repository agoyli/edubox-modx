...
if (typeof window !== 'undefined' && window['pdfjs-dist/build/pdf']) {
  ...
  pdfjsLib = require('/assets/templates/front/pdf.js/build/pdf.js');
}
...
var defaultOptions = {
  ...
  cMapUrl: {
    value: '/assets/templates/front/pdf.js/web/cmaps/',
    kind: OptionKind.API
  },
  disableAutoFetch: {
    value: false,
  ...
  workerSrc: {
    value: '/assets/templates/front/pdf.js/build/pdf.worker.js',
    kind: OptionKind.WORKER
  }
};
{
